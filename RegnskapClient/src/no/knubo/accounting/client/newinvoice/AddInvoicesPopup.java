...
public class AddInvoicesPopup extends DialogBox implements ClickHandler {
    ...
    public AddInvoicesPopup(RegisterInvoiceChooseInvoiceTypePage caller, Elements elements, BigDecimal amount,
            boolean repeat) {
    ...
    private void add() {
        ...
        InvoiceSplitType splitType = InvoiceSplitType.getSplitType(caller.splitType);
