 ...
 * 
 * Modified for Fritt Regnskap by Knut Erik Borgen
 */

package no.knubo.accounting.client.richtexttoolbar;
...
public class RichTextToolbar extends Composite {
    ...
    private static final String HTTP_STATIC_ICONS_GIF = "images/icons-for-toolbar.gif";
    ...
    private PushButton h1Tag;
    private PushButton h2Tag;
    private PushButton h3Tag;
    private PushButton h4Tag;
    ...
    private void buildTools() {
        ...
        topPanel
                .add(superscript = createToggleButton(HTTP_STATIC_ICONS_GIF, 0, 620, 20, 20, GUI_HOVERTEXT_SUPERSCRIPT));
        topPanel.add(new HTML("&nbsp;"));
        ...
        bottomPanel.add(new HTML("&nbsp;"));
        bottomPanel.add(h1Tag = createPushButton(HTTP_STATIC_ICONS_GIF, 38, 23, 20, 20, "H1"));
        bottomPanel.add(h2Tag = createPushButton(HTTP_STATIC_ICONS_GIF, 38, 49, 20, 20, "H2"));
        bottomPanel.add(h3Tag = createPushButton(HTTP_STATIC_ICONS_GIF, 38, 74, 20, 20, "H3"));
        bottomPanel.add(h4Tag = createPushButton(HTTP_STATIC_ICONS_GIF, 38, 98, 20, 20, "H4"));
