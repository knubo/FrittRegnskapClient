...
public interface I18NAccount extends com.google.gwt.i18n.client.Messages {
    ...
    /**
     * Translated "Penger inngis på format 10.45 og må være større eller lik
     * 0".
     * 
    ...
    /**
     * Translated "Fikk ikke forventet svar fra server. Operasjonen er trolig
     * ikke gjennomført.".
     * 
     * @return translated "Fikk ikke forventet svar fra server. Operasjonen er
     *         trolig ikke gjennomført."
     ...
     * 
     * @return translated "Fikk ikke svar fra server. Program- eller
     *         databasefeil."
     ...
     * som serverversjonen. Klientversjonen er {0} og serverversjonen er {1}.
     * Prøv en shift reload av siden. Dette kan gjøre at deler av
     * applikasjonen ikke fungerer som forventet.".
     * 
     * @return translated "Din cachet(?) versjon av klienten er ikke på samme
     *         versjon som serverversjonen. Klientversjonen er {0} og
     *         serverversjonen er {1}. Prøv en shift reload av siden. Dette kan
     *         gjøre at deler av applikasjonen ikke fungerer som forventet."
